<template>
  <li class="todo-item" @mouseenter="showButtons" @mouseleave="disableButtons">
...
export default {
  ...
  methods: {
    ...
    showButtons(e) {
      const buttons = e.target.querySelector(".buttons");
      buttons.classList.remove("btn-disable");
    },
    disableButtons(e) {
      const buttons = e.target.querySelector(".buttons");
      buttons.classList.add("btn-disable");
    },
  },
};
</script>
